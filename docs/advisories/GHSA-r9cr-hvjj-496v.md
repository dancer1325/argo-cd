...
- **GHSA:** [GHSA-r9cr-hvjj-496v](https://github.com/argoproj/argo-cd/security/advisories/GHSA-r9cr-hvjj-496v)
- **CVE:** CVE-2022-24730
- **Severity:** high
- **Published:** 2022-03-23T13:38:26Z
...
|---------|-----------------|---------|
| github.com/argoproj/argo-cd | 1.3.0 through 2.1.10, 2.2.5, 2.3.0-rc5 | 2.1.11, 2.2.6, 2.3.0 |
