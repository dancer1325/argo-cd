# External URLs for Deployments can include javascript

- **GHSA:** [GHSA-h4w9-6x78-8vrj](https://github.com/argoproj/argo-cd/security/advisories/GHSA-h4w9-6x78-8vrj)
- **CVE:** CVE-2022-31035
- **Severity:** critical
- **Published:** 2022-06-21T17:13:07Z
...
|---------|-----------------|---------|
| github.com/argoproj/argo-cd | 1.0.0 through 2.1.15, 2.2.9, 2.3.4, 2.4.0 | 2.1.16, 2.2.10, 2.3.5, 2.4.1 |
