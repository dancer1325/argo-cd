...
- **GHSA:** [GHSA-r642-gv9p-2wjj](https://github.com/argoproj/argo-cd/security/advisories/GHSA-r642-gv9p-2wjj)
- **CVE:** CVE-2022-29165
- **Severity:** critical
- **Published:** 2022-05-18T13:08:40Z
...
|---------|-----------------|---------|
| github.com/argoproj/argo-cd | 1.4.0 through 2.1.14, 2.2.8, 2.3.3 | 2.3.4, 2.2.9, 2.1.15 |
