...
* `kubectl patch configmap argocd-cm -n argocd --type merge --patch-file patchDisableDeployInCluster.yaml`
* `argocd cluster list`
  * 's return: NOTHING
### -> ❌by default, you can NOT deploy Argo CD Applications❌
* [try to deploy the apps](https://github.com/dancer1325/argocd-example-apps/tree/master/apps)
* `argocd app list`
  * 's return: InvalidSpecError
* | ArgoCD UI,
  * https://localhost:8080/applications
    * NO Application displayed
